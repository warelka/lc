...
Создание мероприятия:
    ...
    1. CreateEvent - создать мероприятие, адреса созданных контрактов можно будет найти по порядковому номеру в функции Events.
    2. Инициализировать FR и MP, (первый аргумент при вызове функций Init – порядковый номер)
